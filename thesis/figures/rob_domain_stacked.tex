...
\end{axis}
\end{tikzpicture}
\caption{Risk-of-bias ratings by domain and overall ($n = 74$). The gradient from Domain~1 (85.1\% high) to Domain~3 (55.4\% high) indicates that participant selection is the most persistent source of weakness, while interpretive practices are relatively stronger (see Section~\ref{sec:rob-results}).}
