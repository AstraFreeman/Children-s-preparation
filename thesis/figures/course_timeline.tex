...
\begin{axis}[
    ...
    grid=major,
    grid style={gray!30},
    legend to name=timelinelegend,
    legend style={font=\scriptsize, legend columns=3, draw=gray!50},
    ymin=-0.5, ymax=4.8,
    xmin=-5, xmax=230,
]
...
\draw[dashed, red!70!black] (axis cs:225,-0.5) -- (axis cs:225,4.8) node[above, font=\tiny, text=red!70!black] {NMT};
\end{axis}
\node[anchor=north] at ([yshift=-14mm]current axis.south) {\ref{timelinelegend}};
\end{tikzpicture}
