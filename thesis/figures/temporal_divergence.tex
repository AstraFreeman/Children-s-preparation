...
\end{axis}
\end{tikzpicture}
\caption{Temporal divergence in MRQS item prevalence (2004--2017 vs.\ 2018--2024). Reporting transparency items (right, green) improved while empirical design items (left, red) declined, revealing a paradox: the field became more transparent about weaker designs (see Section~\ref{sec:mrqs}).}
