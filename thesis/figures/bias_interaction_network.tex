...
\node[annot, below=1pt of sc] (sc-a) {66.1\% underpowered\\90.5\% no effect sizes};
...
\draw[arr] (cv) to[bend left=15]
  node[lbl, pos=0.45, anchor=north east] {cannot distinguish treatment}
  (iv);
