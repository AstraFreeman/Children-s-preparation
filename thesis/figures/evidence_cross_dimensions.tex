...
\node[font=\scriptsize, text=green!60!black, anchor=west] at (4*\cs+0.9, -1*\rs-0.7) {Web: primary};
...
\end{tikzpicture}
\caption{Cross-tabulation of education level and game type across 74 studies: cell values indicate study counts, colour intensity reflects density (some studies span multiple categories) (see Section~\ref{sec:evidence-base}).}
