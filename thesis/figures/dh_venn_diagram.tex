\begin{tikzpicture}
  ...
  % Main domain labels (inside exclusive zones of each circle)
  \node[font=\bfseries, blue!80!black] at (90:4.0cm)
  ...
  \node[font=\bfseries, red!80!black] at (210:4.2cm)
  ...
  \node[font=\bfseries, green!60!black] at (330:4.2cm)
  ...
  % Pairwise intersection labels — centered within overlap petals
  ...
  \node[font=\small\itshape, text width=2.4cm, align=center]
    at ($(H)!0.5!(P) + (30:1.5cm)$) {History\\Education};

  % DH ∩ Pedagogy = "Digital Pedagogy" — bottom petal
  \node[font=\small\itshape, text width=2.4cm, align=center]
    at ($(D)!0.5!(P) + (270:1.5cm)$) {Digital\\Pedagogy};
